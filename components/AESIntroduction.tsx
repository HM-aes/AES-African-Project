        ...
        >
          <div className="inline-flex items-center gap-6 px-8 py-4 rounded-2xl bg-white dark:bg-neutral-900/50 border border-neutral-200 dark:border-neutral-800 backdrop-blur-sm">
            <div className="text-center">
              <p className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-amber-500 to-amber-600 bg-clip-text text-transparent">
                72M+
              </p>
              <p className="text-sm text-muted-foreground dark:text-neutral-400 mt-1">
                Combined Population
              </p>
            </div>
            ...
            <div className="text-left">
              <div className="flex items-center gap-2 mb-1">
                ...
                <p className="text-xs text-muted-foreground dark:text-neutral-500 uppercase tracking-wider">Founded</p>
              </div>
              <p className="text-lg font-bold text-foreground dark:text-white">September 16, 2023</p>
              <p className="text-xs text-muted-foreground dark:text-neutral-500">Liptako-Gourma Charter</p>
            </div>
          </div>
        </motion.div>
