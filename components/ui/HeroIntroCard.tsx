        ...
        <div className="grid lg:grid-cols-5 gap-12 lg:gap-16 items-center">
          ...
          <div ref={imagesRef} className="lg:col-span-2 relative">
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="col-span-2 hero-leader-image overflow-hidden">
                <motion.div
                  whileHover={{ scale: 1.02 }}
                  transition={{ duration: 0.6, ease: [0.25, 0.46, 0.45, 0.94] }}
                  className="relative group"
                >
                  <div className="absolute -inset-2 bg-gradient-to-br from-amber-400/20 to-neutral-400/20 dark:from-amber-500/20 dark:to-neutral-700/20 rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
              ...
              {leaders.slice(1).map((leader) => (
                <div key={leader.name} className="hero-leader-image overflow-hidden">
                  <motion.div
                    whileHover={{ scale: 1.05 }}
                    transition={{ duration: 0.6, ease: [0.25, 0.46, 0.45, 0.94] }}
                    className="relative group"
                  >
                    <div className="absolute -inset-1 bg-gradient-to-br from-amber-400/20 to-neutral-400/20 dark:from-amber-500/20 dark:to-neutral-700/20 rounded-xl blur-lg opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
